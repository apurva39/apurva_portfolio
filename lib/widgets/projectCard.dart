...
class ProjectCard extends StatefulWidget {
  ...
  const ProjectCard({Key key, this.projectIcon, this.projectIconData, this.projectTitle, this.projectDescription, this.projectLink, this.cardWidth, this.cardHeight, this.bottomWidget, this.backImage}) : super(key: key);
